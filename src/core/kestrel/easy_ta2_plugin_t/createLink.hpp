...
#ifndef KESTREL_EASY_TA2_PLUGIN_T_CREATELINK_HPP
#define KESTREL_EASY_TA2_PLUGIN_T_CREATELINK_HPP
...
PluginResponse
easy_ta2_plugin_t<Plugin, Types>::createLink(RaceHandle handle,
...
#endif // #ifndef KESTREL_EASY_TA2_PLUGIN_T_CREATELINK_HPP
